...
include 'security_admin.php';
    ...
    if(isset($_POST['acceptbtn']))
    {
        ...
        // FETCH-UNIQUE-ID
        $query = "select UNIQUE_ID from user where ID='$id'";
        $result = mysqli_query($con,$query);
        $data = mysqli_fetch_assoc($result);
        ...
        if($data['UNIQUE_ID'] == '-')
        {
            ...
            $update = " update user set STATUS='1',UNIQUE_ID='$final_number' where ID='$id' ";
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <?php
                                                                    $id = $data['ID'];
                                                                    $newquery = "select UNIQUE_ID from user where ID='$id'";
