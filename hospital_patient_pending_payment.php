...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="row">
                    <div class="col-sm-12">
                        <h4 style="font-family: monospace;" class="page-title">Pending Payment</h4>
                    </div>
                </div>
                                    ...
                                    <table class="table table-border table-striped custom-table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $queryy = " select * from new_patient where HOSPITAL_NAME='$hospitalname' && STATUS='1' && PAYMENT_STATUS='PENDING' ";
