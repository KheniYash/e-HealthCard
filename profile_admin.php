                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <div class="staff-msg"><a href="edit_profile_admin.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Edit Profile</a></div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><?php echo $data['CITY']; ?></span>
                                                </li>
                                                <li>
